...
pt.FullScreenShot "2-2" : onErrorExit "テストケース = 2-1, Excel行 = 11"
...
pt.Close : onErrorExit "テストケース = 3-1, Excel行 = 17"
pt.ExecuteJS "alert('任意のJavascriptを実行できます。')" : onErrorExit "テストケース = 3-1, Excel行 = 18"
pt.Close : onErrorExit "テストケース = 3-1, Excel行 = 19"
